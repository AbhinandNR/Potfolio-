  ...
  return (
    <div className="flex flex-col overflow-x-hidden">
      ...
      >
            ...
            <div className="relative w-80 h-80 animate-[spin_30s_linear_infinite]">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-white p-6 rounded-2xl shadow-[0_10px_40px_rgba(79,142,247,0.15)] border border-gray-100 animate-[spin_30s_linear_infinite_reverse]">
                  <FaFigma className="text-6xl text-[#F24E1E]" />
                </div>
              </div>
        ...
        {/* Scroll Indicator */}
        <div className="hidden md:flex absolute bottom-8 left-1/2 transform -translate-x-1/2 flex-col items-center gap-2 animate-bounce opacity-70 z-20">
          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            {[
              ...
              },
              {
                ...
                desc: "Comprehensive pet care platform with PHP backend and MySQL database for managing pet services and adoption.",
                github: "https://github.com/AbhinandNR"
              },
              {
